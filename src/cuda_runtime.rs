...
pub const CUDART_VERSION: ::std::os::raw::c_uint = 8000;
#[repr(u32)]
/// *
/// *
/// *
...
extern "C" {
    ...
    pub fn cudaDeviceGetStreamPriorityRange(leastPriority: *mut ::std::os::raw::c_int,
...
extern "C" {
    ...
    pub fn cudaDeviceGetByPCIBusId(device: *mut ::std::os::raw::c_int,
...
extern "C" {
    ...
    pub fn cudaDeviceGetPCIBusId(pciBusId: *mut ::std::os::raw::c_char,
...
extern "C" {
    ...
    pub fn cudaIpcOpenMemHandle(devPtr: *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    ...
    pub fn cudaDeviceGetAttribute(value: *mut ::std::os::raw::c_int,
                                  attr: cudaDeviceAttr,
                                  device: ::std::os::raw::c_int)
                                  -> cudaError_t;
}
extern "C" {
    ...
    pub fn cudaDeviceGetP2PAttribute(value: *mut ::std::os::raw::c_int,
...
extern "C" {
    ...
    /// ::cudaGetDeviceProperties
    pub fn cudaChooseDevice(device: *mut ::std::os::raw::c_int,
...
extern "C" {
    ...
    /// ::cudaSetDeviceFlags,
    /// ::cudaChooseDevice
    pub fn cudaSetValidDevices(device_arr: *mut ::std::os::raw::c_int,
                               len: ::std::os::raw::c_int)
                               -> cudaError_t;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cudaLaunchKernel(func: *const ::std::os::raw::c_void,
                            gridDim: dim3,
                            blockDim: dim3,
...
extern "C" {
    ...
    pub fn cudaFuncSetCacheConfig(func: *const ::std::os::raw::c_void,
...
extern "C" {
    ...
    /// ::cudaDeviceGetCacheConfig,
    /// ::cudaFuncSetCacheConfig
    pub fn cudaFuncSetSharedMemConfig(func: *const ::std::os::raw::c_void,
...
extern "C" {
    ...
    pub fn cudaOccupancyMaxActiveBlocksPerMultiprocessor(numBlocks: *mut ::std::os::raw::c_int,
                                                         func: *const ::std::os::raw::c_void,
...
extern "C" {
    ...
    pub fn cudaSetupArgument(arg: *const ::std::os::raw::c_void,
                             size: usize,
                             offset: usize)
                             -> cudaError_t;
}
...
extern "C" {
    ...
    pub fn cudaMallocManaged(devPtr: *mut *mut ::std::os::raw::c_void,
                             size: usize,
                             flags: ::std::os::raw::c_uint)
                             -> cudaError_t;
}
...
extern "C" {
    ...
    /// ::cudaHostAlloc
    pub fn cudaMallocPitch(devPtr: *mut *mut ::std::os::raw::c_void,
                           pitch: *mut usize,
                           width: usize,
                           height: usize)
                           -> cudaError_t;
...
extern "C" {
    ...
    /// \ref ::cudaMallocHost(void**, size_t) "cudaMallocHost (C API)",
    /// ::cudaFreeHost
    pub fn cudaHostAlloc(pHost: *mut *mut ::std::os::raw::c_void,
                         size: usize,
                         flags: ::std::os::raw::c_uint)
                         -> cudaError_t;
}
extern "C" {
    ...
    pub fn cudaHostRegister(ptr: *mut ::std::os::raw::c_void,
                            size: usize,
                            flags: ::std::os::raw::c_uint)
                            -> cudaError_t;
}
...
extern "C" {
    ...
    pub fn cudaHostGetDevicePointer(pDevice: *mut *mut ::std::os::raw::c_void,
...
extern "C" {
    ...
    /// ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpy(dst: *mut ::std::os::raw::c_void,
...
extern "C" {
    ...
    /// ::cudaMemcpy3DPeerAsync
    pub fn cudaMemcpyPeer(dst: *mut ::std::os::raw::c_void,
                          dstDevice: ::std::os::raw::c_int,
                          src: *const ::std::os::raw::c_void,
                          srcDevice: ::std::os::raw::c_int,
                          count: usize)
...
extern "C" {
    ...
    /// ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpyFromArray(dst: *mut ::std::os::raw::c_void,
...
extern "C" {
    ...
    /// ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpy2D(dst: *mut ::std::os::raw::c_void,
                        dpitch: usize,
                        src: *const ::std::os::raw::c_void,
                        spitch: usize,
                        width: usize,
...
extern "C" {
    ...
    /// ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpy2DFromArray(dst: *mut ::std::os::raw::c_void,
                                 dpitch: usize,
                                 src: cudaArray_const_t,
                                 wOffset: usize,
                                 hOffset: usize,
...
extern "C" {
    ...
    /// ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpyToSymbol(symbol: *const ::std::os::raw::c_void,
                              src: *const ::std::os::raw::c_void,
                              count: usize,
                              offset: usize,
                              kind: cudaMemcpyKind)
...
extern "C" {
    ...
    /// ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpyFromSymbol(dst: *mut ::std::os::raw::c_void,
...
extern "C" {
    ...
    /// ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpyAsync(dst: *mut ::std::os::raw::c_void,
                           src: *const ::std::os::raw::c_void,
                           count: usize,
                           kind: cudaMemcpyKind,
                           stream: cudaStream_t)
...
extern "C" {
    ...
    /// ::cudaMemcpy3DPeerAsync
    pub fn cudaMemcpyPeerAsync(dst: *mut ::std::os::raw::c_void,
                               dstDevice: ::std::os::raw::c_int,
                               src: *const ::std::os::raw::c_void,
                               srcDevice: ::std::os::raw::c_int,
                               count: usize,
...
extern "C" {
    ...
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpyFromArrayAsync(dst: *mut ::std::os::raw::c_void,
                                    src: cudaArray_const_t,
                                    wOffset: usize,
                                    hOffset: usize,
                                    count: usize,
...
extern "C" {
    ...
    /// ::cudaMemcpyFromArrayAsync, ::cudaMemcpy2DFromArrayAsync,
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpy2DAsync(dst: *mut ::std::os::raw::c_void,
                             dpitch: usize,
                             src: *const ::std::os::raw::c_void,
                             spitch: usize,
                             width: usize,
...
extern "C" {
    ...
    /// ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
    pub fn cudaMemcpy2DFromArrayAsync(dst: *mut ::std::os::raw::c_void,
                                      dpitch: usize,
                                      src: cudaArray_const_t,
                                      wOffset: usize,
                                      hOffset: usize,
...
extern "C" {
    ...
    pub fn cudaMemcpyToSymbolAsync(symbol: *const ::std::os::raw::c_void,
                                   src: *const ::std::os::raw::c_void,
                                   count: usize,
                                   offset: usize,
                                   kind: cudaMemcpyKind,
...
extern "C" {
    ...
    pub fn cudaMemcpyFromSymbolAsync(dst: *mut ::std::os::raw::c_void,
                                     symbol: *const ::std::os::raw::c_void,
                                     count: usize,
                                     offset: usize,
                                     kind: cudaMemcpyKind,
...
extern "C" {
    ...
    pub fn cudaMemset(devPtr: *mut ::std::os::raw::c_void,
...
extern "C" {
    ...
    /// ::cudaMemset2DAsync, ::cudaMemset3DAsync
    pub fn cudaMemset2D(devPtr: *mut ::std::os::raw::c_void,
                        pitch: usize,
                        value: ::std::os::raw::c_int,
                        width: usize,
                        height: usize)
...
extern "C" {
    ...
    /// ::cudaMemset2DAsync, ::cudaMemset3DAsync
    pub fn cudaMemsetAsync(devPtr: *mut ::std::os::raw::c_void,
                           value: ::std::os::raw::c_int,
                           count: usize,
                           stream: cudaStream_t)
                           -> cudaError_t;
...
extern "C" {
    ...
    pub fn cudaMemset2DAsync(devPtr: *mut ::std::os::raw::c_void,
                             pitch: usize,
                             value: ::std::os::raw::c_int,
                             width: usize,
                             height: usize,
...
extern "C" {
    ...
    pub fn cudaGetSymbolAddress(devPtr: *mut *mut ::std::os::raw::c_void,
                                symbol: *const ::std::os::raw::c_void)
                                -> cudaError_t;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cudaMemPrefetchAsync(devPtr: *const ::std::os::raw::c_void,
                                count: usize,
                                dstDevice: ::std::os::raw::c_int,
                                stream: cudaStream_t)
                                -> cudaError_t;
...
extern "C" {
    ...
    pub fn cudaMemAdvise(devPtr: *const ::std::os::raw::c_void,
                         count: usize,
...
extern "C" {
    ...
    /// ::cudaMemAdvise
    pub fn cudaMemRangeGetAttribute(data: *mut ::std::os::raw::c_void,
                                    dataSize: usize,
...
extern "C" {
    ...
    /// ::cudaMemPrefetchAsync
    pub fn cudaMemRangeGetAttributes(data: *mut *mut ::std::os::raw::c_void,
                                     dataSizes: *mut usize,
...
extern "C" {
    ...
    pub fn cudaDeviceCanAccessPeer(canAccessPeer: *mut ::std::os::raw::c_int,
                                   device: ::std::os::raw::c_int,
...
extern "C" {
    ...
    /// ::cudaDeviceDisablePeerAccess
    pub fn cudaDeviceEnablePeerAccess(peerDevice: ::std::os::raw::c_int,
                                      flags: ::std::os::raw::c_uint)
                                      -> cudaError_t;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cudaGraphicsMapResources(count: ::std::os::raw::c_int,
...
extern "C" {
    ...
    /// \sa
    /// ::cudaGraphicsMapResources
    pub fn cudaGraphicsUnmapResources(count: ::std::os::raw::c_int,
                                      resources: *mut cudaGraphicsResource_t,
                                      stream: cudaStream_t)
                                      -> cudaError_t;
}
extern "C" {
    ...
    /// ::cudaGraphicsMapResources,
    /// ::cudaGraphicsSubResourceGetMappedArray
    pub fn cudaGraphicsResourceGetMappedPointer(devPtr: *mut *mut ::std::os::raw::c_void,
                                                size: *mut usize,
...
extern "C" {
    ...
    /// \ref ::cudaUnbindTexture(const struct textureReference*) "cudaUnbindTexture (C API)",
    /// \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
    pub fn cudaCreateChannelDesc(x: ::std::os::raw::c_int,
                                 y: ::std::os::raw::c_int,
                                 z: ::std::os::raw::c_int,
                                 w: ::std::os::raw::c_int,
...
extern "C" {
    /// \cond impl_private
    pub fn cudaGetExportTable(ppExportTable: *mut *const ::std::os::raw::c_void,
